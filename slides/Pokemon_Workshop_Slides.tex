...
\begin{frame}{Who am I?}
    \begin{columns}[T]
        ...
        \small
        \textbf{Dr. Harshvardhan} (you can call me Dr. Harsh or Prof. Harsh)
        ...
        \textbf{My Teaching:}
        \begin{itemize}
            \item ISA 201 — Introduction to MIS
            \item ISA 383 — Python for Business Analytics
            \item BDA 625 — Data Mining \& Machine Learning
        \end{itemize}

        \vspace{0.2cm}
        \textbf{Before AUS:}
        \begin{itemize}
            \item PhD, University of Tennessee, Knoxville
            \item MBA, IIM Indore
            \item Strategic Planning \& Modeling, HP
        \end{itemize}

		\column{0.38\textwidth}

        \vspace{0.3cm}
        \textbf{Research:} machine learning, LLMs, applied analytics for business problems.
        ...
        \vspace{0.5cm}
        \footnotesize
        \textcolor{ausred}{\texttt{harshvardhan@aus.edu}}
        
        \vspace{0.5cm}
        \footnotesize
        \textcolor{ausred}{\texttt{www.harsh17.in}}
    \end{columns}
\end{frame}
